...
export default function Marketplace() {
  ...
  const handleWishlist = async (p) => {
    ...
    const wasInWishlist = cart.inWishlist(p.id);
    ...
    <div className="max-w-7xl mx-auto px-6 md:px-8 py-14">
      <div className="mb-8">
        ...
        <h1 className="font-display text-5xl md:text-6xl">
          Fuel. Gear. <span className="gold-text">Greatness.</span>
        </h1>
      </div>
      <div className="flex flex-wrap items-center gap-3 mb-8">
        ...
        <Select value={category} onValueChange={(v) => setParam("category", v)}>
          <SelectTrigger className="w-[180px] rounded-full" data-testid="marketplace-category">
        ...
        <Select value={sort} onValueChange={(v) => setParam("sort", v)}>
          <SelectTrigger className="w-[180px] rounded-full" data-testid="marketplace-sort">
            ...
            return (
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <Link
                    to={`/product/${p.id}`}
                    className="font-semibold mt-1 line-clamp-2 hover:text-red-500 transition-colors"
                  >
                    {p.name}
                  </Link>
                  ...
                  <div className="mt-2 flex items-center justify-between">
                    ...
                    <Button
                      size="icon"
                      onClick={() => handleAdd(p)}
                      className="btn-primary rounded-full w-9 h-9"
